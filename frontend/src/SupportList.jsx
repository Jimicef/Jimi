                ...
                <Box sx={{display: 'flex', flexWrap: "wrap", justifyContent: 'center', alignItems: 'center'}}>
                    {supportList && supportList.map((sup, idx) => (
                        <Card sx={{width: "225px", mx: 1, p: 1, mb: 3, height: "255px"}} key={sup.serviceId}>
                            ...
                            <Box sx={{display: 'flex', alignItems: 'center'}} ><CardGiftcardIcon sx={{fontSize: '15px', color: '#795baf'}} /><Typography variant='body2' sx={{fontWeight: '500', mr:0.5}}>지원형태: </Typography> <Typography variant='body2'>{sup.format}</Typography></Box>
                            {sup.rcvInstitution && <Box sx={{display: 'flex', alignItems: 'center'}}><LocationCityIcon sx={{fontSize: '15px', color: '#795baf'}}/><Typography variant='body2' sx={{fontWeight: '500', mr:0.5}}>접수기관: </Typography><Typography variant='body2'>{sup.rcvInstitution.length>12?sup.rcvInstitution.slice(0,12)+"⋯":sup.rcvInstitution}</Typography></Box>}
