                ...
                <Box sx={{display: 'flex', flexWrap: "wrap", justifyContent: 'center', alignItems: 'center'}}>
                    {supportList && supportList.map((sup, idx) => (
                        <Card sx={{width: "225px", mx: 1, p: 1, mb: 3, height: "255px"}} key={sup.serviceId}>
                            ...
                            <Box sx={{display: 'flex', alignItems: 'center'}}><LocalPhoneIcon sx={{fontSize: '15px', color: '#795baf'}}/><Typography variant='body2' sx={{fontWeight: '500', mr:0.5}}>접수문의: </Typography> <Typography variant='body2'>{sup.phone.length>10?sup.phone.slice(0,10)+"⋯":sup.phone}</Typography></Box>
