                ...
                <Box sx={{display: 'flex', flexWrap: "wrap", justifyContent: 'center', alignItems: 'center'}}>
                    {supportList && supportList.map((sup, idx) => (
                        <Card sx={{width: "225px", mx: 1, p: 1, mb: 3, height: "255px"}} key={sup.serviceId}>
                            ...
                            <br />
                            <Box sx={{display: 'flex', alignItems: 'center'}}><CalendarMonthIcon sx={{fontSize: '15px', color: '#795baf'}}/><Typography variant='body2' sx={{fontWeight: '500', mr:0.5}}>신청기간: </Typography><Typography variant='body2'>{sup.dueDate.length > 10?sup.dueDate.slice(0, 10)+"⋯":sup.dueDate}</Typography></Box>
                            <Box sx={{display: 'flex', alignItems: 'center'}} ><CardGiftcardIcon sx={{fontSize: '15px', color: '#795baf'}} /><Typography variant='body2' sx={{fontWeight: '500', mr:0.5}}>지원형태: </Typography> <Typography variant='body2'>{sup.format.length>10?sup.format.slice(0,10)+"⋯":sup.format}</Typography></Box>
                            {sup.rcvInstitution && <Box sx={{display: 'flex', alignItems: 'center'}}><LocationCityIcon sx={{fontSize: '15px', color: '#795baf'}}/><Typography variant='body2' sx={{fontWeight: '500', mr:0.5}}>접수기관: </Typography><Typography variant='body2'>{sup.rcvInstitution.length>10?sup.rcvInstitution.slice(0,10)+"⋯":sup.rcvInstitution}</Typography></Box>}
                            {sup.phone && <Box sx={{display: 'flex', alignItems: 'center'}}><LocalPhoneIcon sx={{fontSize: '15px', color: '#795baf'}}/><Typography variant='body2' sx={{fontWeight: '500', mr:0.5}}>접수문의: </Typography> <Typography variant='body2'>{sup.phone.length>10?sup.phone.slice(0,10)+"⋯":sup.phone}</Typography></Box>}
