          ...
          <Box> 
            ...
            {message.support ? (
                ...
                <Box>
                  ...
                  {message.support.dueDate && <Typography variant="body2">신청기간: {message.support.dueDate}<br/><br/></Typography>}
                  {/* {message.support.institution && <Typography variant="body2">🏢소관기관: {message.support.institution}<br/><br/></Typography>} */}
                  {message.support.format && <Typography variant="body2">지원형태: {message.support.format}<br/><br/></Typography>}
                  ...
                  {message.support.way && <Typography variant="body2">신청방법: {message.support.way.length>150?message.support.way.slice(0, 150)+"⋯":message.support.way}</Typography>}
