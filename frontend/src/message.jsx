          ...
          <Box> 
            ...
            {message.support ? (
                ...
                <Box>
                  ...
                  {message.support.selection.length>150 ?<Typography variant="body2" onClick={handleSelection}sx={{"&:hover": {color:"grey.500", cursor: 'pointer'}, display: "flex", alignItems:'center', color:"#682699"}}><SendIcon sx={{fontSize: "14px", color: "#682699"}}/>선정기준 전체보기</Typography>:<br/>}
                  ...
                  {message.support.docs && <Typography variant="body2">📑제출서류: {message.support.docs.length>150?message.support.docs.slice(0, 150)+"⋯":message.support.docs}<br/><br/></Typography>} 
                  {message.support.docs.length>150 &&<Typography variant="body2" onClick={handleDocs}sx={{"&:hover": {color:"grey.500", cursor: 'pointer'}, display: "flex", alignItems:'center', color:"#682699"}}><SendIcon sx={{fontSize: "14px", color: "#682699"}}/>제출서류 전체보기</Typography>}
                    ...
                    <Typography variant="body2" onClick={()=>handleQuestion("지원대상이 맞는지 확인하기")} sx={{"&:hover": {color:"grey.500", cursor: 'pointer'}, display: "flex", alignItems:'center', color:"#682699"}}><SendIcon sx={{fontSize: "14px", color: "#682699"}}/>
                    지원대상이 맞는지 확인하기
                    </Typography>
                  <Typography variant="body2" onClick={()=>handleQuestion("지원대상 쉽게보기")} sx={{"&:hover": {color:"grey.500", cursor: 'pointer'}, display: "flex", alignItems:'center', color:"#682699"}}><SendIcon sx={{fontSize: "14px", color: "#682699"}}/>
                    지원대상 쉽게보기                   </Typography>
                  <Typography variant="body2" onClick={()=>handleQuestion("지원내용 쉽게보기")}sx={{"&:hover": {color:"grey.500", cursor: 'pointer'}, display: "flex", alignItems:'center', color:"#682699"}}><SendIcon sx={{fontSize: "14px", color: "#682699"}}/>지원내용 쉽게보기</Typography>
